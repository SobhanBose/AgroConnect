...
from app.v1.cart import responseModels, schemas
from app.v1.utils.database import SessionDep

router = APIRouter(prefix="/cart", tags=["Cart"])


@router.post("/{phone_no}", response_model=responseModels.ShowCart, status_code=status.HTTP_201_CREATED)
...
@router.get("/{phone_no}", response_model=responseModels.ShowCart, status_code=status.HTTP_200_OK)
...
@router.delete("/{phone_no}", response_model=responseModels.HTTPExceptionResponse, status_code=status.HTTP_200_OK)
...
@router.post("/{phone_no}/add", response_model=responseModels.ShowCart, status_code=status.HTTP_201_CREATED)
...
@router.patch("/{phone_no}/{cart_item_id}", response_model=responseModels.ShowCart, status_code=status.HTTP_200_OK)
...
@router.delete("/{phone_no}/{cart_item_id}", response_model=responseModels.ShowCart, status_code=status.HTTP_200_OK)
