      ...
      <div className="relative h-screen flex flex-col justify-center items-start px-6" style={heroBgStyle}>
        ...
        <div className="relative z-10 max-w-xl text-left">
          <h1 className="text-4xl font-bold text-white leading-tight mb-4">
            Sell Directly. <br /> Earn More. <br /> Empower Your Farm.
          </h1>
          <p className="text-white text-base mb-6">
            Connect with consumers, eliminate middlemen, and maximize your income with our intuitive platform.
          </p>
          <button className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-full font-medium transition-all duration-300">
            Get Started
          </button>
          <div className="mt-3">
